...
window.RelationsInit = function (API) {
    window.RelationsSystem = {
        ...
        buildListView: function (vars) {
            const groups = vars.relationGroups || [];
                    ...
                    html += `
                        <div class="relations-card" onclick="window.RelationsSystem.showDetail('${charId}')">
                            <div class="relations-avatar">
                                <img src="${char.avatar || 'assets/images/default-avatar.jpg'}" alt="${char.name}">
                            </div>
                            <div class="relations-card-name">${char.name}</div>
                        </div>
                    `;
                });
        ...
        attachEvents: function () {
            // Events are handled via onclick attributes in HTML
        },
        ...
        showDetail: function (characterId) {
            ...
            this.API.$('#relations-detail-name').text(char.name || 'Unknown');
